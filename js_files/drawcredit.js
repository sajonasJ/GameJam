function drawCredits() {
  ...
  function thanks() {
    ...
    text("TEAM MATES", camera.position.x, camera.position.y + 20);
    text("Lead: Jonas", camera.position.x, camera.position.y + 50);
    text("Deon", camera.position.x, camera.position.y + 80);
    text("Ryota", camera.position.x, camera.position.y + 110);
